...
if __name__ == '__main__':
    ...
    scheduler1 = LinearLR(optimizer, start_factor=0.001, end_factor=0.01, total_iters=50)
    scheduler2 = ConstantLR(optimizer, factor=1.0, total_iters = 50)
    scheduler3 = CosineAnnealingLR(optimizer, T_max=50)
    scheduler = SequentialLR(optimizer, schedulers=[scheduler1, scheduler2, scheduler3], milestones = [50, 100])
